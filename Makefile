# This Makefile is for the Net::Linkedin::OAuth2 extension to perl.
#
...
#     BUILD_REQUIRES => { ExtUtils::MakeMaker=>q[6.59], Test::Harness=>q[3.13], Test::More=>q[0.86], YAML::Tiny=>q[1.33], autodie=>q[0] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Net-Linkedin-OAuth2]
#     INSTALLDIRS => q[site]
#     LICENSE => q[perl]
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[Net::Linkedin::OAuth2]
#     NO_META => q[1]
...
MAKE = make
FULLEXT = Net/Linkedin/OAuth2
BASEEXT = OAuth2
PARENT_NAME = Net::Linkedin
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/Linkedin/OAuth2.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Net/Linkedin
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/Linkedin
...
TO_INST_PM = lib/Net/Linkedin/OAuth2.pm

PM_TO_BLIB = lib/Net/Linkedin/OAuth2.pm \
	blib/lib/Net/Linkedin/OAuth2.pm
...
manifypods : pure_all  \
	lib/Net/Linkedin/OAuth2.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Net/Linkedin/OAuth2.pm $(INST_MAN3DIR)/Net::Linkedin::OAuth2.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Net/Linkedin/OAuth2.pm blib/lib/Net/Linkedin/OAuth2.pm 
